...
$( document ).ready( function ( ) {
    ...
    plist.on( 'click', '.showcomments', function ( ) {
        ...
        if ( refto.html( ) === '' ) {
            ...
            N.html[ plist.data( 'type' ) ].getComments( {
                ...
                else if ( document.location.hash ) $.mobile.silentScroll( $( document.location.hash ).offset( ).top );
            } );
        } else {
            refto.html( '' );
        }
    ...
    plist.on( 'click', '.lurk', function ( e ) {
        var me = $( this );
        var tog = function ( d ) {
            if ( d.status === 'ok' ) me.attr( 'class', 'unlurk' ).attr( 'title', d.message );
        };
        e.preventDefault( );
    ...
    plist.on( 'click', '.unlurk', function ( e ) {
        var me = $( this );
        var tog = function ( d ) {
            if ( d.status === 'ok' ) me.attr( 'class', 'lurk' ).attr( 'title', d.message );
        };
        e.preventDefault( );
    ...
    plist.on( 'click', '.bookmark', function ( e ) {
        var me = $( this );
        var tog = function ( d ) {
            if ( d.status === 'ok' ) me.attr( 'class', 'unbookmark' ).attr( 'title', d.message );
        };
        e.preventDefault( );
    ...
    plist.on( 'click', '.unbookmark', function ( e ) {
        var me = $( this );
        var tog = function ( d ) {
            if ( d.status === 'ok' ) me.attr( 'class', 'bookmark' ).attr( 'title', d.message );
        };
        e.preventDefault( );
