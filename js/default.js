...
$(document).ready(function () {
    ...
    $("#pmcounter").on('click', function (e) {
        ...
        if (list.length) {
            ...
            var l = $(document.createElement("div"));
            l.attr('id', "pm_list");
            t = $('<div id="pm_list_t">').html('<div id="pm_from">Conversations</div>' +
                '<span id="pm_conv"></span><span id="pm_reply"></span><span id="pm_new"></span>');
    ...
    plist.on('click', ".editpost", function (e) {
        ...
        N.json[plist.data('type')].getPost({
            ...
            refto.html(form(fid, hpid, d.message, editlang, "")).trigger("create").find("input[type=button]").eq(0)
            .click(function(e) {
              e.preventDefault();
